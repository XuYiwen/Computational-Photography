function output = foreground_movie(sample_rate,Xd,Yd)
    ...
    for i = 1:length(frame_list)
        ...
        diff_mask = single(diff>0.35); % change it
        ...
        T_inv = fliptform(T);
        toadd = imtransform(fore, T_inv, 'XData',[1 rec_w],'YData',[1 rec_h], 'UData', Xd, 'VData', Yd);
